...
def build_prompt_from_storyboard(storyboard_json: Path) -> str:
    ...
    from build_storyboard_image_prompts import build_prompt

    prompt, _size = build_prompt(load_json(storyboard_json))
    return prompt
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--reference-image", action="append", help="Product image to pass into storyboard image generation")
